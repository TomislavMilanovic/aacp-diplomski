...
\degreesubject{Diplomski sveuèilišni studij raèunarstva} % upisati odgovarajuci naziv studija

% upisati vrstu rada
\documenttype{Diplomski rad}  % Zavrsni rad ili Diplomski rad

\title{Proširiva univerzalna paleta aplikacijskih komandi za interakciju zasnovanu na tipkovnièkim preèacima}   % upisati specificni naslov rada

\date{\MONTH~\the\year.}   % ne dirati - mjesec i godina ?e se upisati sami

\author{Tomislav Milanoviæ}  % upisati svoje ime i prezime
...
\mentor{doc. dr. sc.~Sandi Ljubiæ}   % zamijeniti podacima o svojem mentoru
\maketitleabstract
...
\include{Poglavlje_1-Uvod}
\include{Poglavlje_2-Povezani_radovi}
\include{Poglavlje_3-Realizacija}
\include{Poglavlje_4-Eksperiment}
\include{Poglavlje_5-Rezultati}
\include{Poglavlje_6-Buducnost}
\include{Poglavlje-Zakljucak}
...
\appendix
\include{Prilog_1-Suglasnost_za_testiranje}
\include{Prilog_2-Predispitna_anketa}
\include{Prilog_3-Eksperimentalni_zadaci}
\include{Prilog_4-Postispitna_anketa}
\include{Prilog_5-Tablica_za_ispitivaca}
